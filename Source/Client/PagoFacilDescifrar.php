<?php
namespace Pagofacil\Pagofacildirect\Source\Client;
/**
 * Clase para descifrar contenido de transacciones con 3D Secure (3DS), en PHP
 * 
 * NOTA:
 * Para PHP 7.1 o inferior, utilice el mÃ©todo "desencriptar"
 * Para PHP 7.2 o superior, utilice el mÃ©todo "desencriptar_php72"
 */
class PagoFacilDescifrar
{    
    const AUTORIZADO = 1;
    const RECHAZADO = 0;
     ...
     * (3DS), para PHP versiÃ³n 7.2 o superior. Requiere el mÃ³dulo OpenSSL instalado.
     * 
     * @param type $encodedInitialData Cadena encriptada que regresa la API
     * @param type $key Llave de cifrado proporcionada por PagoFÃ¡cil
     */
